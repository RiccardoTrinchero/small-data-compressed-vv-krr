...
%
% This script reproduces the VV-KRR results for Example 1, including:
...
MODEL = train_VVRR_CV_learn_v20(X_ED_norm,Y_ED,kx,ko,[],5,tol,'s','L2');
...
% Legend
legend({'Reference', 'Model #4'}, 'FontSize', FS, 'Location', 'best', 'FontName', 'Arial');
