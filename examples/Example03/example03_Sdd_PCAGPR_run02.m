...
%
% This script reproduces the PCA+GPR results for Example 3 S_dd, including:
% 1) the PCA+GPR entry corresponding to model #22 in Table 6,
% 2) the scatter plot for S_dd21,
% 3) the parametric plot for S_dd21.
%
...
legend('Model #22', 'FontSize', FS, 'Location', 'southeast', 'FontName', 'Arial')
...
legend({'Reference', 'Model #22'}, ...
    'FontSize', FS, 'Location', 'southwest', 'FontName', 'Arial')
